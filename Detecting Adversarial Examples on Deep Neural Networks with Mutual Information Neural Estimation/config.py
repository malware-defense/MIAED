...
def get_arguments_drebin():
    parser = argparse.ArgumentParser()

    parser.add_argument('--imageH', type=int, default=11, help='the hight of image, default = 28')
    parser.add_argument('--imageW', type=int, default=11, help='the width of image, default = 28')
    parser.add_argument('--channel', type=int, default=1, help='the channel of image, default=1')
    parser.add_argument('--epochs', type=int, default=50, help='number of epochs, default = 100')
